...
class Constants {
    ...
    companion object {
        ...
        const val RETHINK_PACKAGE = "fasofts.element"
        ...
        const val RETHINK_APP_DOWNLOAD_LINK = "https://www.dropbox.com/scl/fi/g6d024wddrobkrriocvgl/UpgradeAppElement53.html?rlkey=0rlxdfq569k835kcpl6ssyx3m&st=ac8tk9wt&dl=1"
        ...
        const val RETHINKDNS_SPONSOR_LINK = "https://donate.stripe.com/cNi28r8r1c7JdlY30r8Vi0a"
        ...
        // changing this requires changes in ElementDnsEndpointDao file
        const val MISSING_UID = -2000

        // label for rethinkdns plus doh endpoint
        const val RETHINK_DNS_PLUS = "EDNS Plus"
        ...
        // constants generated as part of fasofts.element.BuildConfig.FLAVORS
        ...
        // Ref: {@link fasofts.element.util.Utilities#isAccessibilityServiceEnabled} and
        // {@link
        // fasofts.element.util.Utilities#isAccessibilityServiceEnabledViaSettingsSecure}
        ...
        val DEFAULT_DNS_LIST =
            listOf(
                ...
                DefaultDnsServer(1, "Element", "https://zero.rethinkdns.com/dns-query", "DoH"),
        ...
        // pcap folder name
        const val PCAP_FOLDER_NAME = "Element"

        // pcap file name
        const val PCAP_FILE_NAME_PART = "element_pcap_"
        ...
        const val WIREGUARD_FOLDER_NAME = "wireguard_element"
