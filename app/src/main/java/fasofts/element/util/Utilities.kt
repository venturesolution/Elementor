...
import fasofts.element.database.AppInfoRepository.Companion.NO_PACKAGE
import fasofts.element.net.doh.CountryMap
import fasofts.element.service.BraveVPNService
import fasofts.element.service.DnsLogTracker
import fasofts.element.util.Constants.Companion.FLAVOR_FDROID
import fasofts.element.util.Constants.Companion.FLAVOR_HEADLESS
import fasofts.element.util.Constants.Companion.FLAVOR_PLAY
import fasofts.element.util.Constants.Companion.FLAVOR_WEBSITE
import fasofts.element.util.Constants.Companion.INVALID_UID
import fasofts.element.util.Constants.Companion.LOCAL_BLOCKLIST_DOWNLOAD_FOLDER_NAME
import fasofts.element.util.Constants.Companion.MISSING_UID
...
object Utilities {
    ...
    fun getPrivateDnsMode(context: Context): PrivateDnsMode {
        // https://github.com/@fernandoangeli/rethink-app/issues/408
        if (!isAtleastQ()) {
