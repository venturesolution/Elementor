...
import fasofts.element.service.FirewallManager.deletePackage
...
import fasofts.element.util.AndroidUidConfig
import fasofts.element.util.Constants
import fasofts.element.util.PlayStoreCategory
import fasofts.element.util.UIUtils
import fasofts.element.util.Utilities
import fasofts.element.util.Utilities.getActivityPendingIntent
import fasofts.element.util.Utilities.isAtleastO
import fasofts.element.util.Utilities.isAtleastT
import fasofts.element.util.Utilities.isNonApp
...
internal constructor(
    ...
    private suspend fun addMissingPackages(apps: Set<FirewallManager.AppInfoTuple>) {
        ...
        apps.forEach {
            // no need to avoid adding Element app to the database, so commenting the below line
