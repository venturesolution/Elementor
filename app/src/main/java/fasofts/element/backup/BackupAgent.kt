 ...
 */
package fasofts.element.backup
...
import fasofts.element.backup.BackupHelper.Companion.CREATED_TIME
import fasofts.element.backup.BackupHelper.Companion.DATA_BUILDER_BACKUP_URI
import fasofts.element.backup.BackupHelper.Companion.METADATA_FILENAME
import fasofts.element.backup.BackupHelper.Companion.PACKAGE_NAME
import fasofts.element.backup.BackupHelper.Companion.SHARED_PREFS_BACKUP_FILE_NAME
import fasofts.element.backup.BackupHelper.Companion.TEMP_ZIP_FILE_NAME
import fasofts.element.backup.BackupHelper.Companion.VERSION
import fasofts.element.backup.BackupHelper.Companion.deleteResidue
import fasofts.element.backup.BackupHelper.Companion.getFileNameFromPath
import fasofts.element.backup.BackupHelper.Companion.getRethinkDatabase
import fasofts.element.backup.BackupHelper.Companion.getTempDir
import fasofts.element.backup.BackupHelper.Companion.startVpn
import fasofts.element.service.PersistentState
import fasofts.element.util.Utilities
import fasofts.element.util.Utilities.copyWithStream
