 ...
 */
package fasofts.element.ui.bottomsheet
...
import fasofts.element.adapter.FirewallStatusSpinnerAdapter
import fasofts.element.data.ConnectionRules
import fasofts.element.database.ConnectionTracker
import fasofts.element.databinding.BottomSheetConnTrackBinding
import fasofts.element.databinding.DialogInfoRulesLayoutBinding
import fasofts.element.service.DomainRulesManager
import fasofts.element.service.FirewallManager
import fasofts.element.service.FirewallRuleset
import fasofts.element.service.FirewallRuleset.Companion.getFirewallRule
import fasofts.element.service.IpRulesManager
import fasofts.element.service.PersistentState
import fasofts.element.service.VpnController
import fasofts.element.ui.activity.AppInfoActivity
...
class ConnTrackerBottomSheet : BottomSheetDialogFragment(), KoinComponent {
    ...
    private fun initView() {
        ...
        if (info!!.uid == rethinkUid) {
            // do not show rules for ElementDNS app
    ...
    private fun setupClickListeners() {
        ...
        b.bsConnTrackAppNameHeader.setOnClickListener {
            io {
                ...
                uiCtx {
                    // case: app is uninstalled but still available in ElementDNS database
