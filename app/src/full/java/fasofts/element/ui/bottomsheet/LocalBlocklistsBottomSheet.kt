...
import fasofts.element.customdownloader.LocalBlocklistCoordinator
import fasofts.element.databinding.BottomSheetLocalBlocklistsBinding
import fasofts.element.download.AppDownloadManager
import fasofts.element.download.DownloadConstants
...
import fasofts.element.ui.fragment.DnsSettingsFragment
import fasofts.element.util.Constants
import fasofts.element.util.Constants.Companion.INIT_TIME_MS
import fasofts.element.util.Constants.Companion.RETHINK_SEARCH_URL
import fasofts.element.util.Themes.Companion.getBottomsheetCurrentTheme
import fasofts.element.util.UIUtils.clipboardCopy
import fasofts.element.util.UIUtils.fetchToggleBtnColors
import fasofts.element.util.UIUtils.openUrl
import fasofts.element.util.Utilities
import fasofts.element.util.Utilities.convertLongToTime
