...
import fasofts.element.backup.BackupAgent
import fasofts.element.backup.BackupHelper
import fasofts.element.backup.BackupHelper.Companion.BACKUP_FILE_EXTN
import fasofts.element.backup.BackupHelper.Companion.BACKUP_FILE_NAME
import fasofts.element.backup.BackupHelper.Companion.BACKUP_FILE_NAME_DATETIME
...
import fasofts.element.backup.BackupHelper.Companion.INTENT_TYPE_OCTET
import fasofts.element.backup.BackupHelper.Companion.INTENT_TYPE_XZIP
import fasofts.element.backup.RestoreAgent
import fasofts.element.databinding.ActivityBackupRestoreBinding
...
class BackupRestoreBottomSheet : BottomSheetDialogFragment() {
    ...
    private fun backup() {
        ...
        // filename format (Element_DATA_FORMAT.bk)
