...
import fasofts.element.databinding.DialogInfoRulesLayoutBinding
import fasofts.element.databinding.DialogViewLogsBinding
import fasofts.element.databinding.DialogWhatsnewBinding
import fasofts.element.databinding.FragmentAboutBinding
import fasofts.element.scheduler.BugReportZipper.FILE_PROVIDER_NAME
import fasofts.element.scheduler.BugReportZipper.getZipFileName
...
import fasofts.element.util.UIUtils.sendEmailIntent
...
import fasofts.element.util.Utilities.isFdroidFlavour
...
class AboutFragment : Fragment(R.layout.fragment_about), View.OnClickListener, KoinComponent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.e("AboutFragment", "Erro ao iniciar view: ${e.message}", e)
        Toast.makeText(context, "Erro no AboutFragment: ${e.message}", Toast.LENGTH_LONG).show()
        }
    ...
    private fun initView() {
        ...
        /*try {
            ...
            val slicedVersion = if (version.length >= 7) version.substring(0, 7) else version
    ...
    private fun showNewFeaturesDialog() {
        ...
        val version = getVersionName()
        val v = if (version.length >= 7) version.substring(0, 7) else version
