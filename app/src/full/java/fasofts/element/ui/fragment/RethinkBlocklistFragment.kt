...
//import fasofts.element.blocklist.RethinkBlocklistManager
import Logger
...
import fasofts.element.adapter.LocalAdvancedViewAdapter
import fasofts.element.adapter.LocalSimpleViewAdapter
import fasofts.element.adapter.RemoteAdvancedViewAdapter
import fasofts.element.adapter.RemoteSimpleViewAdapter
import fasofts.element.customdownloader.LocalBlocklistCoordinator.Companion.CUSTOM_DOWNLOAD
import fasofts.element.data.AppConfig
import fasofts.element.data.FileTag
import fasofts.element.databinding.FragmentRethinkBlocklistBinding
import fasofts.element.download.AppDownloadManager
import fasofts.element.download.DownloadConstants.Companion.DOWNLOAD_TAG
import fasofts.element.download.DownloadConstants.Companion.FILE_TAG
import fasofts.element.service.PersistentState
import fasofts.element.service.RethinkBlocklistManager
import fasofts.element.service.RethinkBlocklistManager.RethinkBlocklistType.Companion.getType
import fasofts.element.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_NAME
import fasofts.element.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_TYPE
import fasofts.element.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_URL
import fasofts.element.ui.bottomsheet.RethinkPlusFilterBottomSheet
import fasofts.element.util.Constants
import fasofts.element.util.Constants.Companion.DEAD_PACK
import fasofts.element.util.Constants.Companion.DEFAULT_RDNS_REMOTE_DNS_NAMES
import fasofts.element.util.Constants.Companion.MAX_ENDPOINT
import fasofts.element.util.Constants.Companion.RETHINK_STAMP_VERSION
import fasofts.element.util.CustomLinearLayoutManager
import fasofts.element.util.UIUtils
import fasofts.element.util.UIUtils.fetchToggleBtnColors
import fasofts.element.util.UIUtils.updateHtmlEncodedText
import fasofts.element.util.Utilities.getRemoteBlocklistStamp
import fasofts.element.util.Utilities.hasLocalBlocklists
import fasofts.element.util.Utilities.hasRemoteBlocklists
import fasofts.element.util.Utilities.showToastUiCentered
import fasofts.element.viewmodel.LocalBlocklistPacksMapViewModel
import fasofts.element.viewmodel.RemoteBlocklistPacksMapViewModel
import fasofts.element.viewmodel.RethinkLocalFileTagViewModel
import fasofts.element.viewmodel.RethinkRemoteFileTagViewModel
