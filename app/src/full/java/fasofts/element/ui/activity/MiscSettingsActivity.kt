...
import fasofts.element.databinding.ActivityMiscSettingsBinding
import fasofts.element.net.go.GoVpnAdapter
import fasofts.element.service.PersistentState
import fasofts.element.ui.bottomsheet.BackupRestoreBottomSheet
...
import fasofts.element.util.Utilities.isAtleastR
        ...
        return try {
            ...
            val dir =
                if (isAtleastR()) {
                    ...
                    // create folder in DOWNLOADS/Element
