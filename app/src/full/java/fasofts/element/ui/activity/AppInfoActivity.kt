...
import fasofts.element.adapter.AppWiseDomainsAdapter
import fasofts.element.adapter.AppWiseIpsAdapter
import fasofts.element.database.AppInfo
import fasofts.element.database.ConnectionTrackerRepository
import fasofts.element.databinding.ActivityAppDetailsBinding
import fasofts.element.service.FirewallManager
import fasofts.element.service.FirewallManager.updateFirewallStatus
...
import fasofts.element.util.Constants.Companion.VIEW_PAGER_SCREEN_TO_LOAD
import fasofts.element.util.Themes
import fasofts.element.util.UIUtils.openAndroidAppInfo
...
import fasofts.element.viewmodel.AppConnectionsViewModel
import fasofts.element.viewmodel.CustomDomainViewModel
import fasofts.element.viewmodel.CustomIpViewModel
    ...
    private fun init() {
        ...
        io {
            ...
            uiCtx {
                ...
                // do not show the firewall status if the app is Element
