...
package fasofts.element.adapter
...
import fasofts.element.database.RethinkLog
import fasofts.element.databinding.ConnectionTransactionRowBinding
...
import fasofts.element.ui.bottomsheet.ConnTrackerBottomSheet
import fasofts.element.ui.bottomsheet.RethinkLogBottomSheet
import fasofts.element.util.Constants.Companion.TIME_FORMAT_1
import fasofts.element.util.KnownPorts
import fasofts.element.util.Protocol
import fasofts.element.util.UIUtils.getDurationInHumanReadableFormat
...
class RethinkLogAdapter(private val context: Context) :
    ...
    inner class RethinkLogViewHolder(private val b: ConnectionTransactionRowBinding) :
        ...
        private fun displayProtocolDetails(port: Int, proto: Int) {
            ...
            // https://github.com/@fernandoangeli/rethink-app/issues/42 - #3 - transport + protocol.
